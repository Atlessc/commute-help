  ...
  return (
    <section className="diversion-panel" aria-labelledby="physical-simulation-title">
      ...
      <p className="panel-intro">
        Compares each closure run against the same local background demand and selected trip, reusing an identical completed baseline when one is already cached.
      </p>
  ...
  return (
    <div className="diversion-results">
      <div className="diversion-summary-grid">
        ...
        <Metric label="SUMO free-flow floor" value={duration(summary.free_flow_validation.baseline_sumo_free_flow_seconds)} />
        <Metric label="Baseline source" value={summary.baseline_cache_hit ? 'Cached' : 'Fresh run'} />
      </div>
